...
<div align ="center">
    ...
    <form action ="/komoecontainer/comoeandfoldertree/komoeEng/insertsinDB/insertcomment.php" method ="post" enctype="multipart/form-data">
  <br>
  <table>  
	  <tr class="info">
        <td>Author</td>
    ...
    <td> <p>Your mark</p>  </td>
<td>
1<input type="radio" name="productrate" id =productrate value="1"> <br>
2<input type="radio" name="productrate" id ="productrate" value="2"> <br>
3<input type="radio" name="productrate" id ="productrate" value="3"> <br>
4<input type="radio" name="productrate" id ="productrate" value="4"> <br>
5<input type="radio" name="productrate" id ="productrate" value="5"> <br>
   </td>  
     </tr>
      </table>
     <br>
