...
$gender ='$_POST[gender]';
$desc ='$_POST[desc]';
$prodcond='$_POST[prodcond]'; 

if( move_uploaded_file($temp_name, $root."$folder".$upload_image))
{
 $sql = "INSERT INTO productstbl(Description, Size, Colour, Gender, ProdCondition, ProdImage, ProdImagePath)
  VALUES('$_POST[desc]','$_POST[size]','$_POST[colour]' ,'$_POST[gender]' ,'$_POST[prodcond]', '$upload_image', '$folder')";    
}   
