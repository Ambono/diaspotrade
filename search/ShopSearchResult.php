...
{
   $queryShop = mysqli_query($con, "insert into shopsearchingtbl 
       (SearchedShop,Date,ShopSearcher)
       values('$_POST[Shopname]',Now(),'$user')"); 
   if (mysqli_query($con, $queryShop)) {
 ;
} else {
   ;
}
...
<nav class="navbar navbar-inverse navbar-static-top navbar navbar-default" role="navigation" style ="border-radius: 5px; background-color:#003333; padding-right:4px">
    ...
    <ul class="nav navbar-nav clearleft">
      ...
      <li><a href="/komoecontainer/comoeandfoldertree/komoeEng/help/Help.php">Help</a></li>             
          ...
          <ul class="nav navbar-nav navbar-center clearleft">
              <li>
                 <span style= "color: red"><?php include("../shop/searchedshopname.php") ?> </span>
              </li>
          </ul>
...
<input type="hidden" name="page" value="page=<?php  echo"".$_GET['page'].""?>" />
    ...
    <form action="/komoecontainer/comoeandfoldertree/komoeEng/pages/PagesSetShop.php"  method="post">
<input type="hidden" name="page" value="page=<?php  echo"".$_GET['page'].""?>" />
</form>	
		  
<?php 
//include("../productdetails/ProductDetailsFetcherByShop.php") ;
?>
		  <br>
...
<!--                            Id: {{product.Id}}</br>-->
			   ...
			   <button  id="detailpagebtn" name="detailpagebtn" class="btn btn-info btn-lg" />
                    ...
                    <div>		 
    <?php   include("../pages/PagesSetShop.php")?>
        </div>
        </div>
...
<footer  class="container col-md-12 siteFooter" style ="background-color:#003333"> 
