...
<a href='/komoecontainer/comoeandfoldertree/komoeEng/basket/addtobasketDetailPageVersionForShops.php?id=<?php  echo"".$_GET['id'].""?>'>Add to basket</a></button> 
 </p></td> 
 
<td><a href="#/seller" >Seller's note</a></td>

 <td><p><button  id="backtoprevious" name="backtoprevious" class="btn btn-info btn-lg" />
<a href='/komoecontainer/comoeandfoldertree/komoeEng/basket/addtobasketDetailPageVersionForShops.php?id=<?php  echo"".$_GET['id'].""?>'>Back</a></button> 
 </p></td>
</tr>
</table>
</div>
