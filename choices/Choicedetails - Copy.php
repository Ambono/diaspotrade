...
<script>
img[src=""]{
    display:"http://localhost:81/komoecontainer/comoeandfoldertree/komoeEng/images/DefaultImage.JPG ";
}
</script>
<form action="/komoecontainer/comoeandfoldertree/komoeEng/basket/addtobasketDetailPageVersion.php"  method="post">
...
<a href='/komoecontainer/comoeandfoldertree/komoeEng/basket/addtobasketDetailPageVersion.php?id=<?php  echo"".$_GET['id'].""?>'>Add to basket</a></button> 
 </p></td> 
 
<td><a href="#/seller" >Seller's note</a></td>

 <td><p><button  id="backtoprevious" name="backtoprevious" class="btn btn-info btn-lg" />
<a href='/komoecontainer/comoeandfoldertree/komoeEng/basket/addtobasketDetailPageVersion.php?id=<?php  echo"".$_GET['id'].""?>'>Back</a></button> 
 </p></td>
</tr>
</table>
</div>
...
<div class="col-md-5">
 ...
 <a href='/komoecontainer/comoeandfoldertree/komoeEng/productdetails/RateProduct.php?id=<?php  echo"".$_GET['id'].""?>'>Rate this product and add comment</a>
 </button>
</div>

<div class="col-md-5">
 <button  id="ratesellerbtn" name="ratesellerbtn" class="btn btn-info btn-lg" />
 <a href='/komoecontainer/comoeandfoldertree/komoeEng/productdetails/RateSeller.php?id=<?php  echo"".$_GET['id'].""?>'>Rate this seller and add comment</a>
 </button>
 </p>
</div>
 </div>
