...
<nav class="navbar navbar-inverse navbar-static-top navbar navbar-default" role="navigation" style ="border-radius: 5px; background-color:#003333; padding-right:4px">
    ...
    <ul class="nav navbar-nav clearleft ">
      ...
      <li ><a href="/komoecontainer/comoeandfoldertree/komoeEng/buys/Buy.php?page=0">Buy</a></li>
       <li><a href="/komoecontainer/comoeandfoldertree/komoeEng/gifts/gift.php?page=0">Gift</a></li>
        <li class="active"><a href="/komoecontainer/comoeandfoldertree/komoeEng/swap/swaps.php?page=0">Swaps</a></li>
    ...
    <div class="">
        ...
        <form class="navbar-form" role="search" id="sellerform" method="POST" action="/komoecontainer/comoeandfoldertree/komoeEng/sellers/ItemSearchResult.php?page=0">
...
<p>Sell and Buy as you holiday. sell and buy from the tourist.</p>	
  		  ...
  		  <br>
           <div id="App1" ng-app="retrievingSwapsApp" ng-controller="dbswapsCtrl">   
	    ...
	    <div class="itemtable">  
         ...
         <table class="success">
          ...
          <td><input type ="search" id="searchinput" name="searchinput" ng-model="shopsearch"/></td>       
            ...
            <table id="" class= "table table-hover" id= "prodtbl itemtable" name = "prodtbl">
                <tbody>	
                    <tr ng-repeat="product in data | filter: shopsearch" ng-model ="prodID" ng-model ="Transactionvalue" ng-init="default">				 
                        <td  ng-cloak id="myTd">
<!--                            Id: {{product.Id}}</br>-->
                        </td>
                        ...
                        <td>
                            ...
                            Intention: {{product.Transactionvalue}}</br> 
                        </td> 
                        <td>
                        ...
                        <td>
                         ...
                         <button  id ="addProductbtn" name="AddProductbtn" class="btn btn-success btn-sm" />            
			   ...
			   <button  id="detailpagebtn" name="detailpagebtn" class="btn btn-info btn-lg" />
                ...
                <th>
              <div>
              <?php include("../pages/PagesSetSwaps.php")?>
              </div>                 
                </th>
                </tfoot>
           </table>
  ...
  <footer class=" siteFooter container col-md-12">  
