  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="/komoecontainer/comoeandfoldertree/komoeEng/index.php">Home</a></li>
	   <li><a href="/komoecontainer/comoeandfoldertree/komoeEng/products/Product.php">Register item</a></li>
...
echo 'this is page number:' .$page;  
	 header("location: /komoecontainer/comoeandfoldertree/komoeEng/mypages/mypage.php?page=$page");
         //header("location: ../mypages/mypage.php?page=$page");
	    }
   }else{
