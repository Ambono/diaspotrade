...
<!--   Left and right controls -->
 ...
 <div class ="col-md-4 col-md-offset-3 container" >
    ...
    background-color:white ;">
                <tbody>				
                    <tr ng-repeat="product in data | filter: shopsearch" ng-model ="prodID" ng-init="default">			 
                        ...
                        <td onclick = "getval(this)" ng-cloak>
                      {{product.Description}}</br> 
                       
                      going to: {{product.CityDestin}}<br>
                      deadline:{{product.Availuntil}}</br>
...
<div  ng-repeat="product in data | filter: shopsearch" ng-model ="prodID" ng-init="default"> 
    <div class = "col-md-3 col-md-offset-4" style ="color: green"> {{product.Description}}</div> 
    <br>
        <div class = "col-md-3 " style ="color: navy">  
            Destination: {{product.CityDestin}}<br>
            Expires:<br>{{product.Availuntil}}
            </div>
    <div class = "col-md-3 col-md-offset-1 " style ="color: navy"> 
                      <img src = "http://localhost:81/komoecontainer/comoeandfoldertree/komoeEng/images/{{product.ProdImage}}.JPG" width="100px" height="100px"/>
    </div> 
     <div class = "col-md-3 col-md-offset-4 " style ="color: navy"> 
      {{product.Price}}<br>
                     
      <a href='/komoecontainer/comoeandfoldertree/komoeEng/choices/Choicedetails.php?id={{product.Id}}'> Book this</a>
     </div>                 
 </div>
</div>
