...
<nav class="navbar navbar-inverse navbar-static-top navbar navbar-default" role="navigation" style ="border-radius: 5px; background-color:#003333; padding-right:4px">
   ...
   <?php include("../admin/sitevisitsNumbers.php")?>

<script>
  var fetchEnquiry = angular.module('retrievevisitsQuery', ['angularUtils.directives.dirPagination']);
//var fetchEnquiry = angular.module('retrievevisitsQuery', []);
        fetchEnquiry.controller('queryCtrl', ['$scope', '$http', function ($scope, $http) {
            $http.get("/komoecontainer/comoeandfoldertree/komoeEng/admin/sitevisitsQueryDetails.php")
  ...
  <div class ="">
  		  <br>
           <div id="App" ng-app="retrievevisitsQuery" ng-controller="queryCtrl">   
	  ...
	  <input type ="hidden" name ="prodId" Id ="prodIDinput"> 
         ...
         <table class="success">
          ...
          <td><input type ="search" id="searchinput" name="searchinput" ng-model="visits"/></td>
        </tr> 
	  </table>
		 </br></br> 
	<div class ="" ng-cloack>
...
<!--                <THEAD>
          ...
          <td><input type ="search" id="searchinput" name="searchinput" ng-model="visits"/></td>
                ...
                <tr dir-paginate="visit in data  | filter:visits | itemsPerPage: 10">
                
<!--                    <tr dir-paginate="visit in data | filter: visits " ng-model ="Id" ng-init="default">				 -->
                        <td> <span><b>-{{visit.Id}}-</b><br></span>
                       
                            Session: {{visit.visitor_session}} </br>
                            IP: {{visit.IPs}}</br>                         
                           Date: {{visit.Date}}</br>
