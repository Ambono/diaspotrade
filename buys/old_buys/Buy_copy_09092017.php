...
<i class="fa fa-spinner fa-spin" style="font-size:48px"></i>
	...
	-->	
	  ...
	  <input type ="hidden" name ="prodId" Id ="prodIDinput"> 
	   ...
	   <!--<div id="itemtable"  *ngIf="showLogout();then userLogout else adminlogout">-->
	    <div id="itemtable">
                ...
                <td  ng-cloak id="myTd">{{product.Id}}</td>
                       ...
                       <!--  <td ng-cloak>{{product.Availfrom}}</td> -->
                        ...
                        <td ng-cloak>{{product.Price}}</td>
                          ...
                          // <td > <button  id ="addProductbtn" name="AddProductbtn" class="btn btn-success btn-sm" ng-hide="{{product.Id}}===111" /><!--
                                                                                                                                 -->
