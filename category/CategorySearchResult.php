...
<TITLE>Komoe search result</TITLE> 
  ...
  <div class="input-group">
      <div class="form-group">
          ...
          <check> <input type="checkbox" name="Buy" value="Yes"  /> Buy</check>
           <check> <input type="checkbox" name="Gift" value="Yes"  />  Gift</check> 
           <check> <input type="checkbox" name="Swap" value="Yes"  />Swap</check>
      </div>
     </div>
 <br>
 <button style = "color: darkmagenta" type="submit" class="btn btn-success" name="viewselected">
...
-->
  <div class ="">
  		  <br>
           <div id="" ng-app="categoriesApp" ng-controller="categoriesCtrl">   
	  ...
	  <input type ="hidden" name ="prodId" Id ="prodIDinput"> 
	    ...
	    <div id="itemtable">  
         ...
         <table class="success">
          ...
          <td><input type ="search" id="searchinput" name="searchinput" ng-model="category"/></td>       
          </tr> 
	  </table>
		 </br></br> 
	<div class ="" ng-cloack>
            <table class= "table table-hover" id= "prodtbl" name = "prodtbl">
                <tbody>	
                    <tr ng-repeat="product in data | filter: category " ng-model ="prodID" ng-init="default">				 
			   ...
			   <button  id="detailpagebtn" name="detailpagebtn" class="btn btn-info btn-lg" />
                    ...
                    <th>
    <?php    
    include("../pages/PagesSetCategory.php")?>
	          </th>
                </tfoot>
           </table>  
