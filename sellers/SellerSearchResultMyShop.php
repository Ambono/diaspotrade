...
<!--    <div class="container">-->
    ...
    <ul class="nav navbar-nav navbar-left">
      ...
      <ul class="nav navbar-nav  col-md-offset-1 ">	  
	   <li> <span style= "color: white"><?php include("../shop/MyShopPicture.php") ?> </span></li>	   
      </ul>	
...
<script>
        ...
        fetch.controller('dbCtrlshopowner', ['$scope', '$http', function ($scope, $http) {
		  ...
		  <br>
           <div id="App1" ng-app="retrievingAppForShopOwners" ng-controller="dbCtrlshopowner">   
...
<!--			Table is productdetails-->
               <thead>
                ...
                <td ng-cloak id="myTd">{{product.Id}}</td>
                       ...
                       <!--  <td ng-cloak>{{product.Availfrom}}</td> -->
                        ...
                        <td ng-cloak>{{product.Price}}</td>
                          ...
                          <span id ="myspan"> Edit</span> </button></td>
				...
				<td><button  id="detailpagebtn" name="detailpagebtn" class="btn btn-info btn-lg" /><a href='/komoecontainer/comoeandfoldertree/komoeEng/choices/ChoicedetailsForOwner.php?id={{product.Id}} page=<?php echo "".$_GET['page'].""?>'>Details</button></td>
